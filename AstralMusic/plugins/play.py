...
from AstralMusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from AstralMusic.core.call import Astral
from AstralMusic.utils import seconds_to_min, time_to_seconds
from AstralMusic.utils.channelplay import get_channeplayCB
from AstralMusic.utils.database import is_video_allowed
from AstralMusic.utils.decorators.language import languageCB
from AstralMusic.utils.decorators.play import PlayWrapper
from AstralMusic.utils.formatters import formats
from AstralMusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from AstralMusic.utils.database import is_served_user
from AstralMusic.utils.inline.playlist import botplaylist_markup
from AstralMusic.utils.logger import play_logs
from AstralMusic.utils.stream.stream import stream
...
@app.on_callback_query(
    filters.regex("AstralymousAdmin") & ~BANNED_USERS
)
async def Astralymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("AstralPlaylists") & ~BANNED_USERS
)
@languageCB
